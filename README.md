[![Validate](https://github.com/projectsense/projectsense/actions/workflows/validate.yml/badge.svg)](https://github.com/projectsense/projectsense/actions/workflows/validate.yml)
[![projectsense NPM](https://img.shields.io/badge/npm-projectsense-blue)](https://www.npmjs.com/package/projectsense)
[![projectsense-core NPM](https://img.shields.io/badge/npm-projectsense--core-blue)](https://www.npmjs.com/package/projectsense-core)
...
<a href="https://www.projectsense.com/?utm_source=readme&utm_medium=github&utm_campaign=projectsense"><img src="https://www.projectsense.com/images/logo/icon_192.png" height="72" alt="projectsense" align="left" /></a>

# Projectsense

<br>

**[Projectsense](https://www.projectsense.com) identifies technologies on websites, such as CMS, web frameworks, ecommerce platforms, JavaScript libraries, analytics tools and [more](https://www.projectsense.com/technologies).**

If you don't have time to configure, host, debug and maintain your own infrastructure to analyse websites at scale, we offer a SaaS solution that has all the same capabilities and a lot more. Our [apps](https://www.projectsense.com/apps/) and [APIs](https://www.projectsense.com/api/) not only reveal the technology stack a website uses but also company and contact details, social media profiles, keywords and metadata.
...
```sh
git clone https://github.com/projectsense/projectsense.git
cd projectsense
yarn install
yarn run link
```
...
A long list of [regular expressions](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Regular_Expressions) is used to identify technologies on web pages. projectsense inspects HTML code, as well as JavaScript variables, response headers and more.

Patterns (regular expressions) are kept in [`src/technologies/`](https://github.com/projectsense/projectsense/blob/master/src/technologies). The following is an example of an application fingerprint.
...
Find the JSON schema at [`schema.json`](https://github.com/projectsense/projectsense/blob/master/schema.json).
